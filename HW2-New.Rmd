...
the two show up in the same frame, but clicking on one point doesn't dynamically update the heatmap??? 
I think this has something to do with keys from shareddata but not quite sure yet. yes! 
